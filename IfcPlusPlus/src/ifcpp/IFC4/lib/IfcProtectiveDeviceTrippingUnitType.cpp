...
void IfcProtectiveDeviceTrippingUnitType::readStepArguments( const std::vector<std::wstring>& args, const std::map<int,shared_ptr<BuildingEntity> >& map )
{
	...
	if( num_args != 10 ){ std::stringstream err; err << "Wrong parameter count for entity IfcProtectiveDeviceTrippingUnitType, expecting 10, having " << num_args << ". Entity ID: " << m_entity_id << std::endl; throw BuildingException( err.str().c_str() ); }
...
void IfcProtectiveDeviceTrippingUnitType::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
