...
void IfcFurnishingElement::readStepArguments( const std::vector<std::wstring>& args, const std::map<int,shared_ptr<BuildingEntity> >& map )
{
	...
	if( num_args != 8 ){ std::stringstream err; err << "Wrong parameter count for entity IfcFurnishingElement, expecting 8, having " << num_args << ". Entity ID: " << m_entity_id << std::endl; throw BuildingException( err.str().c_str() ); }
...
void IfcFurnishingElement::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	IfcElement::getAttributes( vec_attributes );
}
void IfcFurnishingElement::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IfcElement::getAttributesInverse( vec_attributes_inverse );
}
void IfcFurnishingElement::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
