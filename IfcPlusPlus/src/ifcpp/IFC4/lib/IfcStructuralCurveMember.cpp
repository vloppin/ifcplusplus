...
shared_ptr<BuildingObject> IfcStructuralCurveMember::getDeepCopy( BuildingCopyOptions& options )
{
...
void IfcStructuralCurveMember::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_entity_id; }
const std::wstring IfcStructuralCurveMember::toString() const { return L"IfcStructuralCurveMember"; }
void IfcStructuralCurveMember::readStepArguments( const std::vector<std::wstring>& args, const std::map<int,shared_ptr<BuildingEntity> >& map )
{
	const size_t num_args = args.size();
	if( num_args != 9 ){ std::stringstream err; err << "Wrong parameter count for entity IfcStructuralCurveMember, expecting 9, having " << num_args << ". Entity ID: " << m_entity_id << std::endl; throw BuildingException( err.str().c_str() ); }
...
void IfcStructuralCurveMember::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	IfcStructuralMember::getAttributes( vec_attributes );
	vec_attributes.emplace_back( std::make_pair( "PredefinedType", m_PredefinedType ) );
	vec_attributes.emplace_back( std::make_pair( "Axis", m_Axis ) );
}
void IfcStructuralCurveMember::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IfcStructuralMember::getAttributesInverse( vec_attributes_inverse );
}
void IfcStructuralCurveMember::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
