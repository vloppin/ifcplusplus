...
shared_ptr<BuildingObject> IfcSpatialZoneType::getDeepCopy( BuildingCopyOptions& options )
{
...
void IfcSpatialZoneType::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_entity_id; }
const std::wstring IfcSpatialZoneType::toString() const { return L"IfcSpatialZoneType"; }
void IfcSpatialZoneType::readStepArguments( const std::vector<std::wstring>& args, const std::map<int,shared_ptr<BuildingEntity> >& map )
{
	const size_t num_args = args.size();
	if( num_args != 11 ){ std::stringstream err; err << "Wrong parameter count for entity IfcSpatialZoneType, expecting 11, having " << num_args << ". Entity ID: " << m_entity_id << std::endl; throw BuildingException( err.str().c_str() ); }
...
void IfcSpatialZoneType::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
...
void IfcSpatialZoneType::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IfcSpatialElementType::getAttributesInverse( vec_attributes_inverse );
}
void IfcSpatialZoneType::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
