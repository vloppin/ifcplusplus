...
shared_ptr<BuildingObject> IfcDistributionControlElementType::getDeepCopy( BuildingCopyOptions& options )
{
...
void IfcDistributionControlElementType::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_entity_id; }
const std::wstring IfcDistributionControlElementType::toString() const { return L"IfcDistributionControlElementType"; }
void IfcDistributionControlElementType::readStepArguments( const std::vector<std::wstring>& args, const std::map<int,shared_ptr<BuildingEntity> >& map )
{
	const size_t num_args = args.size();
	if( num_args != 9 ){ std::stringstream err; err << "Wrong parameter count for entity IfcDistributionControlElementType, expecting 9, having " << num_args << ". Entity ID: " << m_entity_id << std::endl; throw BuildingException( err.str().c_str() ); }
...
void IfcDistributionControlElementType::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	IfcDistributionElementType::getAttributes( vec_attributes );
}
void IfcDistributionControlElementType::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IfcDistributionElementType::getAttributesInverse( vec_attributes_inverse );
}
void IfcDistributionControlElementType::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
